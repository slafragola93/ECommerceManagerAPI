...
from src.routers import customer, auth, category, brand, shipping_state, product, country, address, carrier, \
    ...
    order_state, order, order_package, order_detail, sync, preventivi, fiscal_documents, init, carriers_configuration, dhl_shipment, shipments, events, csv_import, platform_state_trigger, ddt
