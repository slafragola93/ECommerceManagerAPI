...
class PlatformStateTrigger(Base):
    ...
    id_platform = Column(Integer, ForeignKey('platforms.id_platform', ondelete='CASCADE'), nullable=False, index=True)
    ...
    id_state_platform = Column(Integer, nullable=False, comment="ID stato sulla piattaforma remota")
    ...
    # Relationships
    platform = relationship("Platform", back_populates="state_triggers")
