...
class ConditionalGetMiddleware(BaseHTTPMiddleware):
    ...
    def __init__(self, app: ASGIApp, cache_control_ttl: int = 300):
        ...
        self.cacheable_endpoints = {
            ...
            "GET /api/v1/app-configs/by-category",
            "GET /api/v1/app-configs/category/{category}",
            "GET /api/v1/app-configs/company-info",
            "GET /api/v1/app-configs/electronic-invoicing",
            "GET /api/v1/app-configs/exempt-rates",
            "GET /api/v1/app-configs/fatturapa",
            "GET /api/v1/app-configs/email-settings",
            "GET /api/v1/app-configs/api-keys",
            "GET /api/v1/app-configs/{configuration_id}",
            "GET /api/v1/orders/",
            ...
            "GET /api/v1/carriers_assignments",
            "GET /api/v1/carriers_assignments/{carrier_assignment_id}",
            ...
            "GET /api/v1/shipping_state",
            "GET /api/v1/shipping_state/{shipping_state_id}",
